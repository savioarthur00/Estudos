...
//Desafio 2
function conversaoNumberParaString(num:number){
...
let List_numeros: number[] = [1,2,3]
List_numeros.push(4)

console.log(List_numeros)
console.log(List_numeros[2])

const Array_numeros: Array<number> =[0,1,2,3]
...
const array_any:  any =[1,"teste",true,[],{nome:"Sávio"}]
...
const pessoaObj:{nome:string, surname:string} = {nome: "Sávio",surname:"Arthur"}

// propriedades opcionais, só colocar: ?
const pessoaObj2:{nome:string, surname?:string} = {nome: "Sávio",surname:"Arthur"}

//Validando parametro opcional 

function formaCorreta(name:string,sobrenome?:string){
...
function receberNouS (balance: string | number){
...
// Interface vs Type -- Interface pode ser incrementado
...
function showDirection(direction: "left"|"rigth"|"up"){
